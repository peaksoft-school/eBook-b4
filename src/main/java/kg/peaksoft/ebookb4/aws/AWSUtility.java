...
//
//    private final String accessKey = BucketName.AWS_ACCESSKEY.getAwsCredentials();
//    private final String secretKey = BucketName.AWS_SECRETKEY.getAwsCredentials();
//    private final String bucketName = BucketName.AWS_BUCKET_NAME.getAwsCredentials();
...
//        try {
//            S3Object object = amazonS3Client.getObject(BucketName.AWS_BUCKET_NAME.getAwsCredentials(), key);
