...
public class BookGetServiceImpl implements BookGetService {
    ...
    public List<GenreRequest> getCountGenre() {
        ...
        genreRequest.add(new GenreRequest(genreRepository.getById(1L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(2L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(3L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(4L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(5L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(6L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(7L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(8L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(9L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(10L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(11L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(12L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(13L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(14L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(15L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(16L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(17L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(18L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(19L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(20L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(21L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(22L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(23L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(24L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(25L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(26L).getRusName()));
        genreRequest.add(new GenreRequest(genreRepository.getById(27L).getRusName()));
