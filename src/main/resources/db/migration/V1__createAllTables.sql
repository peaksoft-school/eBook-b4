...
create table basket (basket_id int8 not null, user_id int8, primary key (basket_id));
    ...
    create table users (user_id int8 not null, email varchar(50), first_name varchar(255), last_name varchar(255), number varchar(255), password varchar(120), role_id int8, primary key (user_id));
