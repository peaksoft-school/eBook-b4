...
create table book (book_id int8 not null, about_book varchar(255), author_full_name varchar(255), baskets int4 not null, book_type varchar(255), discount int4, discount_from_promo int4, genre varchar(255), is_active boolean not null, is_best_seller boolean, language varchar(255), likes int4 not null, price numeric(19, 2), publishing_house varchar(255), title varchar(255), year_of_issue date, audiobook_id int8, ebook_id int8, paperbook_id int8, primary key (book_id));
...
create table promocode (id int8 not null, beginning_day date, discount int4 not null, end_day date, promocode varchar(255), user_id int8, primary key (id));
